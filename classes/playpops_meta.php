  ...
  // Construct
	...
	public function mmGetShareButtons($urlshare, $playpops_skip_message)
	{
		...
		*/
		...
		$sharebuttons = '
		<!-- Facebook -->
		<a href="http://www.facebook.com/sharer.php?u=' . $urlshare . '" target="_blank">
			<img src="' . $dirImages . '/facebook.png" alt="Facebook" />
		</a>
 
		<!-- Twitter -->
		<a href="http://twitter.com/share?url=' . $urlshare . '&text=Areyoupop Share Buttons&hashtags=areyoupop" target="_blank">
			<img src="' . $dirImages . '/twitter.png" alt="Twitter" />
		</a>
 
		<!-- Google+ -->
		<a href="https://plus.google.com/share?url=' . $urlshare . '" target="_blank">
			<img src="' . $dirImages . '/googleplus.png" alt="Google" />
		</a>
 
		<!-- Digg -->
		<a href="http://www.digg.com/submit?url=' . $urlshare . '" target="_blank">
			<img src="' . $dirImages . '/digg.png" alt="Digg" />
		</a>
 
		<!-- LinkedIn -->
		<a href="http://www.linkedin.com/shareArticle?mini=true&url=' . $urlshare . '" target="_blank">
			<img src="' . $dirImages . '/linkedin.png" alt="LinkedIn" />
		</a>
 
		<!-- StumbleUpon-->
		<a href="http://www.stumbleupon.com/submit?url=' . $urlshare . '&title=Areyoupop Share Buttons" target="_blank">
			<img src="' . $dirImages . '/stumbleupon.png" alt="StumbleUpon" />
		</a>
 
		<!-- Email -->
		<a href="mailto:?Subject=[Areyoupop] PlayPops Plugin&Body=I%20saw%20this%20and%20thought%20of%20you!%20 http://www.areyoupop.com">
			<img src="' . $dirImages . '/email.png" alt="Email" />
		</a>';
	...
	*/
	...
	public function mmFacebookLike($fb_pageurl, $playpops_skip_message)
	{
		...
		$popskipmsg = '<div style="clear:both;"><a style="cursor:pointer;" id="mmSkipVideo">' . $playpops_skip_message . '</a></div>';

		// define the small box
		$iframe_box320 = '<div id="fbframelikeSmall" style="left:60px; top:2px; display:none; ">
