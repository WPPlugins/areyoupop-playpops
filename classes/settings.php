		...
		function mmPlaypops_Admin_Notice()
		{
			...
			if(isset($settings['playpops_youtube_key'])) 
			{
				...
				if(!$this->mmValidateKey($mmPlaypopsKey))
					...
					<p>PlayPops for Wordpress : <b>Invalid Key</b>. Obtain your <b>Playpops Key</b> by signing up at <a href="http://dev.areyoupop.com/playpops/getkeys/">Playpops Keys</a></p>
					</div>';
			}
			else
			{
				...
				echo '<div class="error">
					<p>PlayPops for Wordpress : Obtain your <b>Playpops Key</b> by signing up at <a href="http://dev.areyoupop.com/playpops/getkeys/">Playpops Keys</a></p>
					</div>';
			}
      ...
      <input type="text" name="<?php // echo $this->general_settings_key; ?>[playpops_transparency]" value="<?php // echo (isset($this->general_settings['playpops_transparency'])?esc_attr($this->general_settings['playpops_transparency']):'0.7'); ?>" /> <em>(opacity)</em>
		...
		?>
      	<input type="radio" name="<?php echo $this->general_settings_key; ?>[playpops_popuptype]" value="Like" <?php echo $optionlike; ?>>Like
			<br>
			<input type="radio" name="<?php echo $this->general_settings_key; ?>[playpops_popuptype]" value="Share" <?php echo $optionshare; ?> disabled = "" />Share <i>(This option is not available in Lite version)</i>
			<?php
		}
